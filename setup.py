...
setup(name='pytorrentlib',
version='1.2.0',
description="""This library simplifies communication with trackers, composing messages for the bittorrent protocol, etc.""",
long_description="""
# pytorrentlib
...
url='https://github.com/cpyberry/pytorrentlib',
author='cpyberry',
author_email='cpyberry222@gmail.com',
license='Apache-2.0',
packages=["pytorrentlib"],
package_dir={'':'src'},
python_requires=">= 3",
zip_safe=False)